...
\noindent {\bf Basic scheme -- Unpooled Tweets:} The default treats
...
very less number of documents and hence each document of a much larger
size.  Some level of pooling is good, but it should also retain
semantic coherence.
...
improve topic coherence with existing algorithms.
...
coherence. The results presented in Table~\ref{tbl-456} suggest that
hashtag-based pooling outperforms all other pooling strategies
including the default way of training topic models on unpooled
Twitter data.

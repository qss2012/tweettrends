...
pooling scheme with the addition of automatic TF similarity-based
hashtag assignment outperforms all other pooling strategies and
unpooled methods on cluster reconstruction metrics.  In conclusion,
these two novel schemes present LDA users with novel methods for
\emph{significantly} improving LDA topic modeling on Twitter without
requiring any modification of the underlying LDA machinery.

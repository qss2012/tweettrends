...
Another way of evaluating topic models is to compare predictive performance by estimating the probability of a subset of held-out documents.  We used the Left to Right evaluation algorithm as described in \cite{wallach} to calculate these values, which is an unbiased method.  Another approach is the so-called
...
topics.  We did not evaluate the held-out probabilty in later
...
corresponding messages into topical categories. \cite{han2012tist} poprose 
